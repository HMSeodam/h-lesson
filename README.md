# Hmseodam Learning Lab

시작하기: https://hmseodam.github.io/h-lesson

사용자가 제공한 PDF 4쪽을 예시로 만든 **반응형 인문학 학습 웹앱 + 인포그래픽 + 퀴즈 + GitHub 게시 도구**입니다.
...
7. **학습자료 저장** — 고화질 PDF/DOCX/PNG/JPG 내보내기

내보내기는 일반 학습 블록을 **한 카드당 한 페이지**로 유지합니다. 아주 긴 블록만 글자나 카드 중간을 피해서 나누며, 2400px 출력으로 문서와 이미지의 선명도를 높였습니다. 브라우저의 인쇄 기능(Ctrl/Cmd+P)도 A4 가로 방향과 카드 단위 페이지 나눔을 사용합니다.
